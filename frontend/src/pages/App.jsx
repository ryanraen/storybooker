...
export default function App() {
  ...
  return (
    <Box>
      ...
      >
        <Box flex={1}>
          ...
          <Typography variant="body1" color="text.secondary" mb={3}>
            ...
            interests, behaviors, and developmental needs. From teaching morals
            to encouraging creativity, every story is a unique experience.
          </Typography>
      ...
      {/* Call to Action */}
      <Box
        sx={{ py: 10, bgcolor: "#3f51b5", color: "#fff", textAlign: "center" }}
        id="cta"
      >
